...
const Navigation = () => {
  ...
  const openNav = isOpen ? 'block' : 'hidden';
  ...
  return (
    ...
    <div className='flex justify-around items-center text-xs sm:text-sm md:text-md w-full fixed top-0 left-0 bg-white z-20 dark:bg-darkmode pt-5' data-aos='fade-down' data-aos-duration='1700'>
      ...
      <div >
        <a href="/" className='font-semibold text-accent-color'>HoopTrack<FontAwesomeIcon icon={faRocket} /></a>
      </div>

      <div className={`${openNav} absolute top-full left-0 w-full bg-darkmode-bg md:bg-transparent text-white md:text-font-color1 md:flex md:relative md:w-auto md:items-center`}>
